CSSMediaRule//Q21- They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
let Person: { name: string; gender: string; age: number } = {
  name: "Abdul Rafey",
  gender: "Male",
  age: 19,
};
...
let name_1: string = "Ahmed Raza";
let name_2: string = "Abdul Rafey";
let name_3: string = "Muhammad Sufyan";

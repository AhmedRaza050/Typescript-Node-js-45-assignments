...
let transportation = ["BMW S1000RR", "Audi A6", "Tesla Cybertruck"];
...
let Guest = ["Abdul Rafey", "Muhammad Sufyan", "Ameer Hamza"];
Guest.map((items) => {
...
let guests1 = ["Abdul Rafey", "Muhammad Sufyan", "Ameer Hamza"];
let canNotAttend = "Ameer Hamza";
console.log(canNotAttend + "", "can not attend the dinner.");
let newGuest = "Abdul Sammad";
...
// part 1
let guests = ["Abdul Rafey", "Muhammad Sufyan", "Ameer Hamza"];
...
// end of your program.
let myGuest = ["Abdul Rafey", "Muhammad Sufyan", "Ameer Hamza"];
console.log("Due to limited space, only two people are invited for the dinner!");
...
let placesToVisit = ["UAE", "turkey", "Uk", "SaudiArabia", "USA"];
// Print your array in its original order:
...
// inviting to dinner.
let invited = ["Abdul Rafey", "Muhammad Sufyan"];
...
let laptopBrand = ["Dell", "hp", "lenovo", "Apple"];
